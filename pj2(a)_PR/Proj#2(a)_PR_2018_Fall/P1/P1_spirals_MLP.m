...
P1_r = (104 - P1_i) / 104;
for i = 1:97
	P1_x1(i) = P1_r(i) * sin(P1_th(i));
    P1_y1(i) = P1_r(i) * cos(P1_th(i));
    P1_x2(i) = -P1_r(i) * sin(P1_th(i));
    P1_y2(i) = -P1_r(i) * cos(P1_th(i));
end
...
for Iteration = 1:It_max
    ...
    if(MLP_end)
        ...
        ylim([-0.1 0.6]);
        title('Mean Square Error for P1');
        xlabel('Iteration');
        ylabel('MSE');
        grid on;
        break;
